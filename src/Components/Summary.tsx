...
export default function Summary({isguest}: {isguest : boolean}) {
    ...
    return (
        <div>
            <div className=" bg-gray-900/40 rounded-sm px-4 py-4 border mr-2 md:ml-0 ml-2 border-gray-800">
                ...
                {isguest ? <p className="text-4xl py-3 ">$140</p>:
                ...
                <div className="text-gray-400 flex gap-5 pt-5 pb-3">
                    <div>
                        <h3>Invested</h3>
                        {isguest ? <p className="text-white">
                            $3550
                           </p> : 
                        <p className="text-white">
                            ${investedamount?.toFixed(2)}</p>
                            }
                    </div>

                    <div>
                        <h3>Current</h3>
                        {isguest ?   <p className="text-white">$3690</p> :
